    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <!-- Logo -->
                <a href="/vendor/control-panel/index2.html" class="logo">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="/vendor/control-panel/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                                        Support Team
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="/vendor/control-panel/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="/vendor/control-panel/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                                        Developers
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="/vendor/control-panel/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview menu-open">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="/vendor/control-panel/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                                <li class="active"><a href="/vendor/control-panel/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="/vendor/control-panel/pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
                                <li><a href="/vendor/control-panel/pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Boxed</a></li>
                                <li><a href="/vendor/control-panel/pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Fixed</a></li>
                                <li><a href="/vendor/control-panel/pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
                            </ul>
                        </li>
                        <li>
